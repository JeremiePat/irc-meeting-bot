...
function L10N(cfg) {
  ...
  [
    { id: 'nohelp', str: ['Sorry, no help available!'] },
    { id: 'record', str: ['Record done.'] },
    { id: 'begin',  str: ['Meeting is recorded now.'] },
    { id: 'end',    str: ['Meeting is over.'] },
    { id: 'format', str: ['Minutes has been formated.']},
    { id: 'hi',     str: ['Hi! I\'m ready to record your meeting'] }
